package sample.dataloader.spark;
...
import sample.dataloader.config.SparkConfig;
...
@Getter
@Component
public class LoaderSparkSession {
    private final SparkConfig sparkConfig;
    private SparkSession sparkSession;

    public LoaderSparkSession(SparkConfig sparkConfig) {
